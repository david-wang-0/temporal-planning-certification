...
"interfering_at_start a = sorted_list_of_set {n. mutex_snap_action a (at_start (act n))}"
...
"interfering_at_end a = sorted_list_of_set {n. mutex_snap_action a (at_end (act n))}"
