...
begin
  ...
  text \<open>If there is no self-overlap, the condition for mutex validity condition on the annotated action
...
section \<open>Characterisation of some temporal planning problems\<close>
