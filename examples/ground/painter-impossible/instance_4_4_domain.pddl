...
(:durative-action _make_treatment1_i2_i3_t3_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 4)
 ...
 :condition
  (and
   (at start (s1_i2_t3_last_t))
   (at start (next_to_treat_t3_i2))
   (at start (not_busy))
   (at start (not_treated_i2_t3))
   (at start (not_started_i2_t3))
   (at start (ready_i2_t3))
  )
 :effect (and
  (at start (not (not_started_i2_t3)))
  (at start (not (not_busy)))
  (at start (not (next_to_treat_t3_i2)))
  (at start (not (s1_i2_t3_last_t)))
  (at start (busy))
  (at start (next_to_treat_t3_i3))
  (at start (started_i2_t3))
  (at end (not (not_treated_i2_t3)))
  (at end (not (busy)))
  (at end (not_busy))
  (at end (s2_i2_t3_last_t))
  (at end (treated_i2_t3))
 )
)
...
(:durative-action _make_treatment1_i2_i3_t2_t3_
 :parameters ()
 :duration
  (and
   (>= ?duration 4)
...
(:durative-action _make_treatment2_i2_t3_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 6)
 ...
 :condition
  (at start (s2_i2_t3_last_t))
 :effect (and
  (at start (not (s2_i2_t3_last_t)))
  (at end (s3_i2_t3_last_t))
...
(:durative-action _make_treatment2_i2_t2_t3_
 :parameters ()
 :duration
  (and
   (>= ?duration 6)
 ...
 :condition
  (at start (s2_i2_t2_t3))
 :effect (and
  (at start (not (s2_i2_t2_t3)))
  (at end (s3_i2_t2_t3))
  (at end (ready_i2_t3))
 )
)
...
(:durative-action _make_treatment3_i2_t3_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 5)
 ...
 :condition
  (and
   (at start (s3_i2_t3_last_t))
   (at end (started_i2_last_t))
  )
 :effect (and
  (at start (not (s3_i2_t3_last_t)))
  (at end (s4_i2_t3_last_t))
 )
)
...
(:durative-action _make_treatment3_i2_t2_t3_
 :parameters ()
 :duration
  (and
   (>= ?duration 5)
 ...
 :condition
  (and
   (at start (s3_i2_t2_t3))
   (at end (started_i2_t3))
  )
 :effect (and
  (at start (not (s3_i2_t2_t3)))
  (at end (s4_i2_t2_t3))
 )
)
...
(:durative-action _make_treatment_container_i2_t3_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 16)
...
(:durative-action _make_treatment_container_i2_t2_t3_
 :parameters ()
 :duration
  (and
   (>= ?duration 16)
