...
(:durative-action _make_treatment1_i0_i1_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 4)
 ...
 :effect (and
  ...
  (at start (not (s1_i0_t1_last_t)))
  (at start (next_to_treat_t1_i1))
  (at start (busy))
  (at start (started_i0_t1))
  (at end (not (not_treated_i0_t1)))
  (at end (not (busy)))
  (at end (s2_i0_t1_last_t))
  (at end (treated_i0_t1))
  (at end (not_busy))
 )
)
(:durative-action _make_treatment1_i1_i2_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 4)
 ...
 :effect (and
  ...
  (at end (not (busy)))
  (at end (not_busy))
  (at end (s2_i1_t1_last_t))
  (at end (treated_i1_t1))
 )
)
(:durative-action _make_treatment1_i2_i3_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 4)
...
(:durative-action _make_treatment2_i0_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 6)
 ...
 :condition
  (at start (s2_i0_t1_last_t))
 :effect (and
  (at start (not (s2_i0_t1_last_t)))
  (at end (s3_i0_t1_last_t))
  (at end (ready_i0_last_t))
 )
)
(:durative-action _make_treatment2_i1_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 6)
 ...
 :condition
  (at start (s2_i1_t1_last_t))
 :effect (and
  (at start (not (s2_i1_t1_last_t)))
  (at end (s3_i1_t1_last_t))
  (at end (ready_i1_last_t))
 )
)
(:durative-action _make_treatment2_i2_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 6)
 ...
 :condition
  (at start (s2_i2_t1_last_t))
 :effect (and
  (at start (not (s2_i2_t1_last_t)))
  (at end (s3_i2_t1_last_t))
...
(:durative-action _make_treatment3_i0_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 5)
 ...
 :condition
  (and
   (at start (s3_i0_t1_last_t))
   (at end (started_i0_last_t))
  )
 :effect (and
  (at start (not (s3_i0_t1_last_t)))
  (at end (s4_i0_t1_last_t))
 )
)
(:durative-action _make_treatment3_i1_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 5)
 ...
 :condition
  (and
   (at start (s3_i1_t1_last_t))
   (at end (started_i1_last_t))
  )
 :effect (and
  (at start (not (s3_i1_t1_last_t)))
  (at end (s4_i1_t1_last_t))
 )
)
(:durative-action _make_treatment3_i2_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 5)
 ...
 :condition
  (and
   (at start (s3_i2_t1_last_t))
   (at end (started_i2_last_t))
  )
 :effect (and
  (at start (not (s3_i2_t1_last_t)))
  (at end (s4_i2_t1_last_t))
 )
)
...
(:durative-action _make_treatment_container_i0_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 16)
 ...
 :effect (and
  (at start (s1_i0_t1_last_t))
  (at end (not (s4_i0_t1_last_t)))
 )
)
(:durative-action _make_treatment_container_i1_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 16)
 ...
 :effect (and
  (at start (s1_i1_t1_last_t))
  (at end (not (s4_i1_t1_last_t)))
 )
)
(:durative-action _make_treatment_container_i2_t1_last_t_
 :parameters ()
 :duration
  (and
   (>= ?duration 16)
