...
proof
  ...
  proof -
    have ntas_inits_alt: "ntas_inits = InitialLocation # map Off actions" unfolding ntas_inits_def nta_init_def ntas_def timed_automaton_net_spec_def Let_def prod.case
